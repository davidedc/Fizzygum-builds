...
BoxMorph = (function(_super) {
  ...
  BoxMorph.prototype.updateBackingStore = function() {
    var context;
    this.image = newCanvas(this.extent().scaleBy(pixelRatio));
    context = this.image.getContext("2d");
    context.scale(pixelRatio, pixelRatio);
    if ((this.edge === 0) && (this.border === 0)) {
      BoxMorph.__super__.updateBackingStore.call(this);
      return null;
    }
    context.fillStyle = this.color.toString();
    context.beginPath();
...
CaretMorph = (function(_super) {
  ...
  CaretMorph.prototype.updateBackingStore = function() {
    var context;
    CaretMorph.__super__.updateBackingStore.call(this);
    context = this.image.getContext("2d");
    context.font = this.target.font();
    return null;
  };
...
ColorPaletteMorph = (function(_super) {
  ...
  ColorPaletteMorph.prototype.updateBackingStore = function() {
    var context, ext, h, l, x, y, _i, _j, _ref, _ref1;
    console.log("ColorPaletteMorph updateBackingStore");
    ext = this.extent();
    this.image = newCanvas(this.extent().scaleBy(pixelRatio));
    context = this.image.getContext("2d");
    context.scale(pixelRatio, pixelRatio);
...
ColorPickerMorph = (function(_super) {
  ...
  ColorPickerMorph.prototype.buildSubmorphs = function() {
    var cpal, gpal, x, y;
    console.log("ColorPickerMorph buildSubmorphs");
    this.destroyAll();
...
InspectorMorph = (function(_super) {
  ...
  InspectorMorph.prototype.save = function() {
    ...
    try {
      ...
      if (this.target.updateBackingStore) {
        this.target.changed();
        this.target.updateBackingStore();
        return this.target.changed();
      }
    ...
    return this.prompt("new property name:", ((function(_this) {
      return function(prop) {
        if (prop != null) {
          ...
          if (_this.target.updateBackingStore) {
            _this.target.changed();
            _this.target.updateBackingStore();
...
MenuMorph = (function(_super) {
  ...
  MenuMorph.prototype.updateBackingStore = function() {
    var fb, isLine, x, y;
    isLine = false;
    this.destroyAll();
    this.children = [];
    ...
    MenuMorph.__super__.updateBackingStore.call(this);
    return this.extent();
  };
  ...
  MenuMorph.prototype.maxWidth = function() {
    ...
    this.children.forEach(function(item) {
      ...
      return console.log("maxWidth: width of item " + item + " : " + w);
    });
    if (this.label) {
  ...
  MenuMorph.prototype.adjustWidthsOfMenuEntries = function() {
    ...
    return this.children.forEach((function(_this) {
      return function(item) {
        ...
        return console.log("new width of " + item + " : " + item.width());
      };
    })(this));
  };
...
ShadowMorph = (function(_super) {
  ...
  ShadowMorph.prototype.updateBackingStore = function() {
    ...
    if (WorldMorph.preferencesAndSettings.useBlurredShadows && !WorldMorph.preferencesAndSettings.isFlat) {
      ...
      this.setPosition(fb.origin.add(this.offset).subtract(this.targetMorph.shadowBlur));
    } else {
      this.image = this.targetMorph.shadowImage(this.offset, this.color);
      this.setPosition(fb.origin.add(this.offset));
    }
    return this.extent();
  };
...
SliderButtonMorph = (function(_super) {
  ...
  SliderButtonMorph.prototype.updateBackingStore = function() {
    ...
    if (this.parent != null) {
      ...
      this.setPosition(new Point(posX, posY).add(this.parent.bounds.origin));
    }
...
SliderMorph = (function(_super) {
  ...
  SliderMorph.prototype.updateBackingStore = function() {
    SliderMorph.__super__.updateBackingStore.call(this);
    return null;
  };
...
SpeechBubbleMorph = (function(_super) {
  ...
  SpeechBubbleMorph.prototype.updateBackingStore = function() {
    return SpeechBubbleMorph.__super__.updateBackingStore.call(this);
  };
...
StringFieldMorph = (function(_super) {
  ...
  StringFieldMorph.prototype.updateBackingStore = function() {
    var txt;
    txt = (this.text ? this.getValue() : this.defaultContents);
    this.text = null;
    this.destroyAll();
    ...
    StringFieldMorph.__super__.updateBackingStore.call(this);
...
TextMorph = (function(_super) {
  ...
  TextMorph.prototype.calculateAndUpdateExtent = function() {
  ...
  TextMorph.prototype.updateBackingStore = function() {
    var c, context, line, offx, offy, p, shadowHeight, shadowWidth, start, stop, width, x, y, _i, _j, _k, _len, _len1, _ref, _ref1;
    this.image = newCanvas();
    context = this.image.getContext("2d");
    context.font = this.font();
    this.breakTextIntoLines();
...
morphicVersion = 'version of 2015-02-23 21:26:07';
