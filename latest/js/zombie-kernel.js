...
SystemTestsRecorderAndPlayer = (function() {
  ...
  SystemTestsRecorderAndPlayer.prototype.runNextSystemTest = function() {
    ...
    SystemTestsControlPanelUpdater.addMessageToSystemTestsConsole("playing test: " + this.testsList()[this.indexOfSystemTestBeingPlayed]);
    this.testCommandsSequence = window[this.testsList()[this.indexOfSystemTestBeingPlayed]].testCommandsSequence;
    return this.startTestPlaying();
  };
